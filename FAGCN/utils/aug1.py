...
def aug_random_mask(input_feature, drop_edge=0.2):
    
    node_num = input_feature.shape[1]
    mask_num = int(node_num * drop_edge)
...
def aug_random_edge(input_adj, drop_edge=0.2):
    ...
    edge_num = int(len(row_idx))      # 9228 / 2
