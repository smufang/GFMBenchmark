...
> **Note**: Generating GCOPE `induced_graph` and GraphCLIP summaries locally is time/memory-consuming. We strongly suggest downloading the **Pre-processed Files** directly or just using the Full Bundle.
